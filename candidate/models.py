...
class Application(models.Model): # Application Model
    ...
    candidate_phone = models.CharField(default="Inconnu",max_length=10)  # Phone Number of the candidate (Optional)
    ...
    password_reset_token = models.CharField(null=True,blank=True,max_length=200) # Token used to reset the candidate password, not set unless the user ask for a reset
