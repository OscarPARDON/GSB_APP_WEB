...
# Form used to update data about an existing application
class ApplicationUpdateForm(forms.ModelForm):
    ...
    def clean(self): # function for personalized form data verification
        ...
        if cv : # If cv file value is set ...
            ...
            if not cv or (cv.size == None or cv.size > 30000000):  # If the file is bigger than 30Mo ...
        ...
        if cover_letter : # If cover letter file is set ...
            ...
            # File Size Verification
            if not cover_letter or (cover_letter.size == None or cover_letter.size > 30000000):  # If the file is bigger than 30Mo ...
                raise forms.ValidationError("Le fichier ne doit pas être vide et être inférieur à 30Mo")  # Sends the error

        return cleaned_data # return transformed data

# Form used to collect the user's email
...
# Form used to collect the user's Application Number
