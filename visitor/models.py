...
class Publication(models.Model): # Publication / Job Offer Model
    ...
    archived = models.BooleanField(default=False) # Boolean to know if the publication is archived or not
